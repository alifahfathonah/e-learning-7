...
<body>
	...
	<?php
		$query = "SELECT FirstName,LastName,Gender,Email_id,UserName,Password FROM user_info WHERE User_ID='$username'";
	...
	if(isset($_POST['fname']) && isset($_POST['lname']))
	{
		...
		$user = $_POST['user'];
		$password = $_POST['pass'];
		$query = "UPDATE user_info SET FirstName='$fname',LastName='$lname',Gender='$gender',Email_id='$email',UserName='$user',Password='$password' WHERE User_id='$username'";
		$result = mysqli_query($strconn,$query);
		if($result)
		{
