...
<body>
	<?php
		...
		$query1 = "SELECT UserName FROM user_info WHERE User_id='$username'";
	...
	<div class="container">
			...
			data-validation-required-message="Please enter your User Name" value="<?php echo $id; ?>"/>
	...
	if(!empty($_POST['name'])&&!empty($_POST['message']))
	{
		if(isset($_POST['btnsubmit']))
		{
			$name = $_POST["name"]; 
            $msg = $_POST["message"];
			$query = "SELECT User_id FROM user_info WHERE User_id='$username'";
