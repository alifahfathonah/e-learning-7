...
<body>
	...
	<form method="POST" action="#">
		<table border=0 align="center">
			...
			placeholder="Description" id="message" name="desc" required
			...
			<tr>
				<td colspan="2" align="center"><button class="btn btn-block" name="submit">Create Lecture</button></td>
			</tr>
	...
	<?php
		if(isset($_POST['submit']))
		{
			...
			$info = $_POST['info'];
			$d = $_POST['desc'];
			$query = "INSERT INTO lecture(course,Title,Info,summary) VALUES('$subject','$title','$info', '$d')";
			$result = mysqli_query($strconn,$query);
			if($result)
			{
